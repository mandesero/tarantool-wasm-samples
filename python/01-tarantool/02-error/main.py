...
from wit_world.imports import say, error
from wit_world.imports.types import BoxError, ErrorCode, LogContext
...
def test_error():
    ...
    err: BoxError = error.new_with_location(
        ErrorCode.UNKNOWN, "from python", f().f_code.co_filename, f().f_lineno
    )
